...
//! per-immunity ([`witness_tier`](crate::audit::ImmunityAudit::witness_tier) /
//! [`has_witness`](crate::audit::ImmunityAudit::has_witness)); what was missing is the
//! **per-class roll-up** — audit emits one
//! [`ImmunityAudit`](crate::audit::ImmunityAudit) per immunity *site*, never a verdict
//! per failure-*class*.
